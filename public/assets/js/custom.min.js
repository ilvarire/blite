            ...
            $(".user-btn").on("click", function () {
                ...
                $(".btn-close").on("click", function () {
                    $("#drawer1").removeClass("drawer-show"),
                        ...
                        $(".filter-category-sidebar").removeClass(
                            "drawer-show"
                        ),
        ...
        i = function () {
            $(".sub-menu-down").on("click", function () {
                $(this).toggleClass("active"),
                    ...
                    $(".navbar > li .sub-menu").hasClass("show") &&
                        ($(".navbar > li .sub-menu").removeClass("show"),
                        $(this).children(".sub-menu").toggleClass("show")),
                    $(".sub-menu-down").hasClass("active") &&
            ...
            document.addEventListener("mousemove", (t) => {
                ...
                document.querySelectorAll("[data-cursor]").forEach((e) => {
                    e.addEventListener("mouseover", (a) => {
                        "pointer" === e.dataset.cursor &&
                            ((t.style.backgroundColor =
                                "rgba(255, 255, 255, .6)"),
                            t.style.setProperty("--size", "30px")),
                            "pointer2" === e.dataset.cursor &&
                                ((t.style.backgroundColor = "white"),
                                (t.style.mixBlendMode = "difference"),
                                t.style.setProperty("--size", "80px"));
                    }),
                        e.addEventListener("mouseout", (e) => {
                            (t.style.backgroundColor = "unset"),
                                (t.style.mixBlendMode = "unset"),
                                t.style.setProperty("--size", "50px");
                        });
                });
        },
        d = function () {
        ...
        w = function () {
            $(".input-group").on("click", ".button-plus", function (e) {
                !(function e(t) {
                    ...
                    isNaN(o)
                        ? s.find("input[name=" + a + "]").val(0)
                        : s.find("input[name=" + a + "]").val(o + 1);
                })(e);
            }),
