...
function dzSettings({
    ...
    this.themeFullColor_value = themeFullColor_value || "color_3";
    this.themeLayout_value = themeLayout_value || "wide-layout";
    this.headerOption_value = headerOption_value || "sticky-header";
    this.backgroundColor_value = backgroundColor_value || "color_3";
...
(function ($) {
    "use strict";
    dzSettingsOptions = {
        themeFullColor_value: "color_3",
        themeLayout_value: "wide-layout",
        headerOption_value: "sticky-no",
        backgroundColor_value: "color_3",
    };
