<div>
    ...
    <form wire:submit.prevent="updateSiteInfo" id="update_info">
        ...
        <label class="block text-sm mb-2">
            ...
            <input type="tel" wire:model="phone" value="{{ old('phone') }}"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="" required />
            @error('phone')
                <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label class="block text-sm mb-2">
            ...
            <input type="text" wire:model="location" value="{{ old('location') }}"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="" required />
            @error('location')
                <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label class="block text-sm mb-2">
            ...
            <input type="text" wire:model="pickup_location" value="{{ old('pickup_location') }}"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="" required />
        ...
        <label class="block text-sm mb-2">
            ...
            <input type="text" wire:model="pickup_time" value="{{ old('pickup_time') }}"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="" required />
            @error('pickup_time')
                <span class="text-xs text-red-600 dark:text-red-400">
    ...
    <form wire:submit.prevent="updateBank" id="update_bank">
        ...
        <label class="block text-sm mb-2">
            ...
            <input type="text" wire:model="sort_code" value="{{ old('sort_code') }}"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="" required />
            @error('sort_code')
                <span class="text-xs text-red-600 dark:text-red-400">
