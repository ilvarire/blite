<div>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <form wire:submit.prevent="storeCounty" method="POST" class="flex justify-around ml-4 mt-2 flex-1 lg:mr-32">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        <p class="font-semibold"> {{$county->name}} </p>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <flux:modal.trigger name="edit-county">
                                        <button
                                            wire:click="$dispatch('edit-county', { mode: 'edit', county: '{{ $county->slug }}' })"
                                    ...
                                    <flux:modal.trigger name="delete-county">
                                        <button wire:click="$dispatch('delete-county', {id: {{ $county->id}}})"
                                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                            aria-label="Delete">
                                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
    ...
    <flux:modal name="edit-county" class="w-full bg-white rounded-t-lg dark:bg-gray-800  sm:rounded-lg sm:max-w-xl">
        <div>
            <div class="text-center mt-8 mb-2">
                <flux:text class="text-gray-700 dark:text-gray-400">Edit county
                </flux:text>
            </div>

            <div class="mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" id="update_county" wire:submit.prevent="updateCounty">
            ...
            <div class="flex">
                <flux:spacer />
                <button type="submit" form="update_county"
    ...
    <flux:modal name="delete-county" class="bg-white rounded-t-lg dark:bg-gray-800">
        <div>
            <div class="text-center mt-8 mb-2">
                <flux:text class="text-gray-700 dark:text-gray-400">Delete county?
                </flux:text>
            </div>

            <div class="mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <span class="text-sm text-gray-600 dark:text-gray-400">You're about to delete this county</span>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    This will affect food under this county</p>
            </div>
