<section class="sm:pb-[100px] pb-[40px] relative">
    <div class="container">
        <div class="2xl:mb-[50px] mb-[25px] relative mx-auto text-center">
            <h2 class="font-lobster">Our Equipments</h2>
        </div>
            ...
            <div class="swiper menu-swiper" wire:ignore>
                <div class="swiper-wrapper">
                    @forelse($equipments as $equipment)
                        <div class="swiper-slide" wire:key="equipment-{{ $equipment->id }}">
                            <div class="slide-box">
                                <div class="dz-img-box2 group">
                                    <div class="w-full min-w-full h-full">
                                        <img src="{{ asset('storage/' . $equipment->images->first()->image_url) }}" alt=""
                                            class="block w-full">
                                    </div>
                                    <span
                                    ...
                                    <div
                                        ...
                                        <div class="info relative">
                                            <h5 class="mb-0">
                                                <a class="text-white"
                                                    href="{{ route('equipment.details', $equipment->slug)}}">
                                                    {{$equipment->name}}
                                                </a>
                                            </h5>
                                        ...
                                        <a href="javascript:;">
                                            <i wire:click.prevent="addEquipmentToCart({{$equipment->id}})"
