<x-layouts.customer-layout :page="'Cart'" :title="'Cart - Blite Authentic African Flavours & Premier Catering Solutions'">
    <!-- Search Section -->
                            ...
                            <div class="dz-content sm:p-5 p-2 flex flex-col w-full">
                                ...
                                <div class="dz-body sm:flex block justify-between">
                                    <ul class="dz-meta flex mx-[-10px]">
                                        ...
                                        <li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i
                                                class="flaticon-scooter mr-1 text-xl text-primary"></i>
                                            fast delivery
                                        </li>
                                    </ul>
                                    <p class="mb-0">
